...
const Variables = () => {
  ...
  const HANDOUT_TITLE = "Correlational Coefficients Excercise";
          ...
          <Grid item>
              ...
              <Grid item xs>
                <Paper className={classes.questionPaper}>
                  <Typography component="h3">
                    For each of the following correlations, draw the scatterplot
                    of the relationship. Then, for each, please indicate:{" "}
            ...
            <Grid container>
              <Grid item xs>
                <Paper className={classes.questionPaper}>
                  <Typography component="h3">
                    3. r = -.53 between age and likelihood of falsely confessing
                    to a crime.
                  </Typography>
                  <List component="ol" dense={true}>
                    <ListItem className={classes.questionEm}>a)</ListItem>
              ...
              <Grid item xs>
                <Paper className={classes.questionPaper}>
                  <Typography component="h3">
                    ...
                    would the correlation coefficient be? Draw the scatter plot
                    as you did for the examples above
                  </Typography>
                  <List component="ol" dense={true}>
                    <ListItem className={classes.questionEm}>a)</ListItem>
                    <ListItem className={classes.questionEm}>b)</ListItem>
